package com.example.uasdpm2011500098
...
class MainActivity : AppCompatActivity() {
    private lateinit var adpDataDosen: AdapDosen
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        dataDosen = ArrayList()
        adpDataDosen = AdapDosen(this@MainActivity, dataDosen)
        ...
        btnTambah.setOnClickListener {
            val i = Intent(this@MainActivity, EnteryDataDosen::class.java)
            startActivity(i)
        }
    }
